...
public class TSPOptimization3 extends HierarchicalIS3<Sequence> {

	private PrintStream[] ps;
	
	public TSPOptimization3(int sample_num, int level, CostFunction<Sequence> cf) {
	...
	public static void main(String args[]) {
		try {
			...
			TSPOptimization3 tspo=new TSPOptimization3(40,5,cf);
