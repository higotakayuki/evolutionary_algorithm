...
public class TSPOptimization4 extends HierarchicalIS4<Sequence> {

	private PrintStream[] ps;
	
	public TSPOptimization4(int sample_num, int level, CostFunction<Sequence> cf) {
	...
	public static void main(String args[]) {
		try {
			...
			TSPOptimization4 tspo=new TSPOptimization4(40,5,cf);
			for (long i = 0; i < 1000; i++) {
				System.out.println("----------------" + i + "----------------");
				tspo.optimize();
				System.out.println(tspo);
				System.out.println(tspo.getBest());
			}
