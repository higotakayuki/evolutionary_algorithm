...
public class TSPOptimization6 extends HierarchicalIS6<Sequence> {

	private PrintStream[] ps;
	
	public TSPOptimization6(int sample_num, int level, CostFunction<Sequence> cf) {
	...
	public static void main(String args[]) {
		try {
			...
			TSPOptimization6 tspo=new TSPOptimization6(20,5,cf);
