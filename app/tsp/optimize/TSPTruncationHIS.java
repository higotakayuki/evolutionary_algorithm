...
public class TSPTruncationHIS extends TruncationHIS<Sequence>{

	private PrintStream[] ps;
	
	public TSPTruncationHIS(int sample_num, int level, CostFunction<Sequence> cf) {
	...
	public static void main(String args[]) {
		try {
			...
			TSPTruncationHIS tspo=new TSPTruncationHIS(10,10,cf);
