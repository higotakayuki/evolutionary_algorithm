...
import optimize.his.old.HierarchicalIS5;
...
public class HIS_DiscreteUMDA5 extends HierarchicalIS5<DVector> {
	private PrintStream[] ps;

	private static int dim = 100;

	public HIS_DiscreteUMDA5(int sample_num, int level, CostFunction<DVector> cf) {
	...
	public static void main(String args[]) {
		try {
			...
			CostFunction<DVector> cf = new RecordFunction<DVector>(
					new TwoMax(dim), ps);
			HIS_DiscreteUMDA5 disc = new HIS_DiscreteUMDA5(40, 5, cf);
