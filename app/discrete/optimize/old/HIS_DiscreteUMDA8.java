...
import optimize.his.old.HierarchicalIS8;
...
public class HIS_DiscreteUMDA8 extends HierarchicalIS8<DVector> {
	private PrintStream[] ps;

	private static int dim = 100;

	public HIS_DiscreteUMDA8(int sample_num, int level, CostFunction<DVector> cf) {
	...
	public static void main(String args[]) {
		try {
			...
			CostFunction<DVector> cf = new RecordFunction<DVector>(
					new TwoMax(dim), ps);
			HIS_DiscreteUMDA8 disc = new HIS_DiscreteUMDA8(10, 5, cf);
