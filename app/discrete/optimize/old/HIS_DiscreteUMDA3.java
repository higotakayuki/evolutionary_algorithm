...
public class HIS_DiscreteUMDA3 extends HierarchicalIS3<DVector> {
	private PrintStream[] ps;

	private static int dim = 100;

	public HIS_DiscreteUMDA3(int sample_num, int level, CostFunction<DVector> cf) {
	...
	public static void main(String args[]) {
		try {
			...
			CostFunction<DVector> cf = new RecordFunction<DVector>(
					new TwoMax(dim), ps);
			HIS_DiscreteUMDA3 disc = new HIS_DiscreteUMDA3(40, 5, cf);
